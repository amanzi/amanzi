...
AMANZI_BRANCH=david/amanzi-tpls-0.98.8
AMANZI_SOURCE_DIR=/amanzi/repos/amanzi-tpls-0.98.8
...
docker build --no-cache --progress=plain --build-arg petsc_ver=${PETSC_VER} \
