...
#   0.98.15      - update Trilinos to 16.1.0
#                - correct hypre version labels to 2.33.0 since HYPRE_GIT_TAG
#                  already pointed at v2.33.0 while the version fields still
#                  read 2.31.0
#                - patch ExprTK for nvcc, guard Trilinos mmio symbols for CUDA builds
#                - patch Silo configure to look up HDF5 by SILO_HDF5_LIBNAME instead
#                  of a hardcoded hdf5, so Debug builds find the debug-suffixed
#                  HDF5 libraries HDF5's own CMake produces
