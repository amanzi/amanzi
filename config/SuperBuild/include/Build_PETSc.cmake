...
define_external_project_args(PETSc TARGET petsc DEPENDS ${MPI_PROJECT} METIS BUILD_IN_SOURCE)
...
set(petsc_parmetis_flags --download-parmetis=${real_download_path}/${ParMetis_ARCHIVE_FILE})

set(petsc_package_flags ${petsc_superlu_flags} ${petsc_parmetis_flags} ${petsc_superlu_dist_flags} ${petsc_metis_flags})
