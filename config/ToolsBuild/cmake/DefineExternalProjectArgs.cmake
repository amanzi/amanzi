...
macro(DEFINE_EXTERNAL_PROJECT_ARGS prefix)
  ...
  set(${prefix}_prefix_dir ${ToolsBuild_BINARY_DIR}/${target_lc})
  set(${prefix}_source_dir ${ToolsBuild_BINARY_DIR}/${target_lc}/${target_lc}-${${prefix}_VERSION}-source)
  set(${prefix}_stamp_dir  ${ToolsBuild_BINARY_DIR}/${target_lc}/${target_lc}-timestamps)
  set(${prefix}_tmp_dir    ${ToolsBuild_BINARY_DIR}/${target_lc}/tmp)

  # Default is to build out of source, but some packages can not do that
  if ( NOT PARSE_BUILD_IN_SOURCE ) 
    set(${prefix}_build_dir  ${ToolsBuild_BINARY_DIR}/${target_lc}/${target_lc}-${${prefix}_VERSION}-build)
  else()  
  ...
  if ( DISABLE_EXTERNAL_DOWNLOAD )
	  set(${prefix}_URL ${TOOLS_DOWNLOAD_DIR}/${${prefix}_SAVEAS_FILE})
