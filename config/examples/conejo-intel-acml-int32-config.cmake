...
set(CMAKE_C_FLAGS_RELEASE "-O1" CACHE STRING "Intel C compile flags for Release Build" FORCE)
set(CMAKE_C_FLAGS_RELWITHDEBINFO "-O1 -g" CACHE STRING "Intel C compile flags for RelWithDebInfo build" FORCE)
set(CMAKE_C_FLAGS_MINSIZEREL "-O1" CACHE STRING "Intel C compile flags for MinSizeRel" FORCE)

set(CMAKE_CXX_COMPILER "${MPI_ROOT}/bin/mpicxx" CACHE FILEPATH "MPI C++ compiler wrapper" FORCE)
set(CMAKE_CXX_FLAGS_RELEASE "-O1" CACHE STRING "Intel CXX compile flags for Release Build" FORCE)
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O1 -g" CACHE STRING "Intel CXX compile flags for RelWithDebInfo build" FORCE)
set(CMAKE_CXX_FLAGS_MINSIZEREL "-O1" CACHE STRING "Intel CXX compile flags for MinSizeRel" FORCE)

set(CMAKE_Fortran_COMPILER "${MPI_ROOT}/bin/mpif90" CACHE FILEPATH "MPI Fortran compiler wrapper" FORCE)
set(CMAKE_Fortran_FLAGS_RELEASE "-O1" CACHE STRING "Intel Fortran compile flags for Release Build" FORCE)
set(CMAKE_Fortran_FLAGS_RELWITHDEBINFO "-O1 -g" CACHE STRING "Intel Fortran compile flags for RelWithDebInfo build" FORCE)
set(CMAKE_Fortran_FLAGS_MINSIZEREL "-O1" CACHE STRING "Intel Fortran compile flags for MinSizeRel" FORCE)
