...
.. math:: 
   h^2 = h_0^2 + (h_s^2 - h_0^2) \frac{x}{L_s} 
   + \frac{Q_{src}L_s^2}{K}\left( \frac{x}{L_s} \right) 
     \left(1 - \frac{x}{L_s} \right), \quad 0 \leqslant x \leqslant L_s
...
.. math:: 
   h = 50 \left(2 - \frac{x}{L}  \right), \quad L_s \leqslant x \leqslant L
...
.. math:: 
   \frac{dh}{dx} \vert_{x=L_s^-} 
   = \frac{1}{h_s} \left[ \frac{h_s^2 - h_0^2}{2L_s} 
     - \frac{Q_{src} L_s}{2K} \right] 
   = \frac{h_L - h_s}{L - L_s} = \frac{dh}{dx} \vert_{x=L_s^+}
   :label: massConstraint

where

.. math:: 
   h_s = 50 \left(2 - \frac{L_s}{L} \right)
...
Dupuit, J. 1863. *Estudes Theoriques et Pratiques sur le mouvement des Eaux dans les canaux decouverts et travers les terrains permeables* (Second Edition ed.). Paris: Dunod.
...
.. image:: figures/porflow_4.4.3.png
   :scale: 35 %
   :align: center
