...
class TransientTheis(object):
    ...
    def paramsFromXML(filename):
        ...
        params["h_0"]= search.getElementByPath(xml, "/Main/Boundary Conditions/Far Field Head/BC: Hydrostatic/Times/Time Functions/Water Table Height").value[0]
        params["Q"]= search.getElementByPath(xml, "/Main/Sources/Pumping Well/Assigned Regions/Source: Volume Weighted/Values").value
        ...
        params["x_low"]=search.getElementByPath(xml, "/Main/Entire Domain/Region: Box/Low Coordinate").value[0] 
        params["y_low"]=search.getElementByPath(xml, "/Main/Entire Domain/Region: Box/Low Coordinate").value[1]    
        params["z_low"]=search.getElementByPath(xml, "/Main/Entire Domain/Region: Box/Low Coordinate").value[2]
        params["x_high"]=search.getElementByPath(xml, "/Main/Entire Domain/Region: Box/High Coordinate").value[0]  
        params["y_high"]=search.getElementByPath(xml, "/Main/Entire Domain/Region: Box/High Coordinate").value[1] 
        params["z_high"]=search.getElementByPath(xml, "/Main/Entire Domain/Region: Box/High Coordinate").value[2]
...
if __name__ == "__main__":
    ...
    ax1.plot(radi , s_fixed_time, label = "Theis Solution")
    ax2.plot(times , s_fixed_radius, label = "Theis Solution")
