...
void
fbasin_source(ac::Beaker::BeakerState* state)
{
...
void
fbasin_aqueous_source(ac::Beaker::BeakerState* state)
{
  // constraint: source
...
void
fbasin_free_ions(ac::Beaker::BeakerState* state)
{
...
void
fbasin_minerals(ac::Beaker::BeakerState* state)
{
...
void
fbasin_sorbed(ac::Beaker::BeakerState* state)
{
