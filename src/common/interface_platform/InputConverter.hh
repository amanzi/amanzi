...
class InputConverter {
 ...
 protected:
  ...
  xercesc::DOMElement* GetChildByName_(xercesc::DOMNode* node,
  ...
  std::string GetChildValueS_(xercesc::DOMNode* node,
                              ...
                              bool& flag,
                              bool exception = false);
  std::vector<std::string> GetChildVectorS_(xercesc::DOMNode* node,
                                            const std::string& childName,
                                            bool& flag,
                                            bool exception = false);
  ...
  // -- error messages
  void ThrowErrorIllformed_(const std::string& section,
  ...
  void ThrowErrorMissing_(const std::string& node,
                          const std::string& type,
                          const std::string& key,
                          const std::string& subnode);
  void ThrowErrorMisschild_(const std::string& section,
