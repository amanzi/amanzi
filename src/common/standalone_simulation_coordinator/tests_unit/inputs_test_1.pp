#*******************************************************************************
# INPUTS_TEST_1: Two-phase flow, van-Genuchten, no capillary pressure
#*******************************************************************************

# Model name
# ----------
prob.model_name = two-phase
...
amr.check_file = test_1/chk
amr.plot_file  = test_1/plt
