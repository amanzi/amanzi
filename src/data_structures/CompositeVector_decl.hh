...
class CompositeVector_ : public BlockVector<Scalar> {
 public:
  ...
  Teuchos::RCP<const AmanziMesh::Mesh> getMesh() const { return getMap()->getMesh(); }
  AmanziMesh::Entity_kind getLocation(const std::string& name) const { return getMap()->getLocation(name); }
