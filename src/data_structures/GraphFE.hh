...
class GraphFE {
 public:
  ...
  // fill graph
  void insertLocalIndices(LO row, std::size_t count, LO const * indices);
  void insertGlobalIndices(GO row, std::size_t count, GO const * indices);
  void insertLocalIndices(std::size_t row_count,
                          LO const * row_indices,
                          std::size_t col_count,
                          LO const * col_indices);
  void insertGlobalIndices(std::size_t row_count,
                           GO const * row_indices,
                           std::size_t col_count,
                           GO const * col_indices);

  // finish fill
  void resumeFill();
  void fillComplete(const Map_ptr_type& domain_map, const Map_ptr_type& range_map);
