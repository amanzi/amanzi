...
struct test_bv {
  ...
  test_bv()
  {
    ...
    master_maps["cell"] = mesh->getMap(Entity_kind::CELL, false);
    master_maps["face"] = mesh->getMap(Entity_kind::FACE, false);
    ghost_maps["cell"] = mesh->getMap(Entity_kind::CELL, true);
    ghost_maps["face"] = mesh->getMap(Entity_kind::FACE, true);
