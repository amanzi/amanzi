...
class FunctionBilinear : public Function {
 public:
  FunctionBilinear(const Kokkos::View<double*> &x, const Kokkos::View<double*> &y,
 ...
 private: // helper functions
  void check_args(const Kokkos::View<double*>&, const Kokkos::View<double*>&, const Kokkos::View<double**>&) const;
};
