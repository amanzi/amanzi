...
FunctionPolynomial::FunctionPolynomial (const Kokkos::View<double*> &c, const Kokkos::View<int*> &p, double x0)
{
  if (c.extent(0) < 1) {
    Errors::Message m;
 ...
 double FunctionPolynomial::operator()(const Kokkos::View<double*>& x) const
  {
