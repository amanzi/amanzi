...
TEST_FIXTURE(test, values1)
{
  ...
  functions.push_back(Teuchos::rcp(new FunctionAdditive(std::move(f1), std::move(f2))));

  // Function Multiplicative -------------------------------------
  std::unique_ptr<Function> f3(new FunctionConstant(0.01));
  std::unique_ptr<Function> f4(new FunctionMonomial(1., x0, p));
  functions.push_back(Teuchos::rcp(new FunctionMultiplicative(std::move(f3), std::move(f4))));
  ...
  functions.push_back(Teuchos::rcp(new FunctionComposition(std::move(f5), std::move(f6))));
  ...
  functions.push_back(Teuchos::rcp(new FunctionStaticHead(1.0, 1.0, 1.0, std::move(f9), 2)));
