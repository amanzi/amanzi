...
class Point {
 public:
  ...
  friend KOKKOS_INLINE_FUNCTION Point operator*(const Point& p, const double& r) { return r*p; }
  ...
  friend KOKKOS_INLINE_FUNCTION Point operator/(const Point& p, const double& r) { return p * (1.0/r); }
