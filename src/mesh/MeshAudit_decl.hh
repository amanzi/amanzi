...
struct AuditGraph {
  ...
  // add vertex
  typename Graph::vertex_descriptor addVertex() {
    return boost::add_vertex(g);
  }

  Vertex& getVertex(const typename Graph::vertex_descriptor& desc) {
    return g[desc];
  }
  ...
  void addEdge(typename Graph::vertex_descriptor& vert_out, typename Graph::vertex_descriptor& vert_in) {
    boost::add_edge(vert_out, vert_in, g);
  }
...
// Call these instead
template<class Mesh_type>
void createTestDependencies(MeshAudit_Base<Mesh_type>& audit, AuditGraph<MeshAudit_Base<Mesh_type>>& graph) {
  createTestDependencies_Base(audit, graph);
}
template<class Mesh_type>
void createTestDependencies(MeshAudit_Geometry<Mesh_type>& audit, AuditGraph<MeshAudit_Geometry<Mesh_type>>& graph) {
  createTestDependencies_Geometry(audit, graph);
}
template<class Mesh_type>
void createTestDependencies(MeshAudit_Maps<Mesh_type>& audit, AuditGraph<MeshAudit_Maps<Mesh_type>>& graph) {
  createTestDependencies_Maps(audit, graph);
}
template<class Mesh_type>
void createTestDependencies(MeshAudit_Sets<Mesh_type>& audit, AuditGraph<MeshAudit_Sets<Mesh_type>>& graph) {
...
template<class Mesh_type,
         template<typename T> class MeshAudit_type>
class MeshAudit_ {
 public:
  ...
  int Verify() {
    return graph_.verify(audit_, os_);
  }
