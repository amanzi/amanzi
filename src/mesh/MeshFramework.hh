...
class MeshFramework {
 ...
 public:
  ...
  std::tuple<double, AmanziGeometry::Point, Point_List> computeFaceGeometry(const Entity_ID f) const
  {
  ...
  void getCellFaces(const Entity_ID c, Entity_ID_List& faces) const
  {
    getCellFacesAndDirs(c, faces, nullptr);
  }

  void getCellFaceDirs(const Entity_ID c, Entity_Direction_List& dirs) const
  {
  ...
  void getFaceEdges(const Entity_ID f, Entity_ID_List& edges) const
  {
  ...
  // processors
  virtual void
  getFaceCells(const Entity_ID f, const Parallel_type ptype, Entity_ID_List& cells) const = 0;
  ...
  virtual void
  getEdgeCells(const Entity_ID edgeid, const Parallel_type ptype, Entity_ID_List& cellids) const;
  ...
  virtual void
  getEdgeFaces(const Entity_ID edgeid, const Parallel_type ptype, Entity_ID_List& faceids) const;

  // Cells of type 'ptype' connected to a node
  // NOTE: The order of cells is not guaranteed to be the same for
  // corresponding nodes on different processors
  virtual void
  getNodeCells(const Entity_ID nodeid, const Parallel_type ptype, Entity_ID_List& cellids) const;
  ...
  virtual void
  getNodeEdges(const Entity_ID nodeid, const Parallel_type ptype, Entity_ID_List& edgeids) const;
