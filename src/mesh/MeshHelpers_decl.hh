...
KOKKOS_INLINE_FUNCTION Entity_ID getBoundaryFaceFace(const Mesh_type& mesh, Entity_ID bf);
...
Entity_ID getFaceOnBoundaryBoundaryFace(const MeshCache<MEM>& mesh, Entity_ID f);
...
//
template<class Mesh_type>
KOKKOS_INLINE_FUNCTION Entity_ID getBoundaryFaceInternalCell(const Mesh_type& mesh, Entity_ID bf);
...
//
template<class Mesh_type>
KOKKOS_INLINE_FUNCTION Entity_ID getFaceOnBoundaryInternalCell(const Mesh_type& mesh, Entity_ID f);
...
//
template<class Mesh_type>
KOKKOS_INLINE_FUNCTION AmanziGeometry::Point getFaceNormalExterior(const Mesh_type& mesh,
                                                                   Entity_ID f,
                                                                   int* dir);
...
//
template<class Mesh_type>
KOKKOS_INLINE_FUNCTION int getBoundaryDirection(const Mesh_type& mesh, Entity_ID f);
...
//
template<class Mesh_type>
KOKKOS_INLINE_FUNCTION Entity_ID getFaceAdjacentCell(const Mesh_type& mesh, int c, int f);
...
//
template<class Mesh_type>
typename Mesh_type::Entity_ID_View getCellFaceAdjacentCells(const Mesh_type& mesh,
                                                            Entity_ID c,
                                                            Parallel_kind ptype);
...
//
template<MemSpace_kind MEM>
void copyFacesToBoundaryFaces(const MeshCache<MEM>& mesh,
...
//
template<MemSpace_kind MEM>
void copyBoundaryFacesToFaces(const MeshCache<MEM>& mesh,
...
//
template<MemSpace_kind MEM>
void copyCellsToBoundaryFaces(const MeshCache<MEM>& mesh,
