...
{
  auto owned_contiguous = Teuchos::rcp(new Epetra_Map(-1, owned->NumMyElements(), 0, owned->Comm()));
  ...
  auto ghosted_contiguous = Teuchos::rcp(new Epetra_Map(-1, all_ids.MyLength(), &all_ids[0], 0, owned->Comm()));
