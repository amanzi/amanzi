...
createMapsFromContiguousGIDs(const Mesh_type& mesh, const Entity_kind kind)
{
  ...
  return std::make_pair(Teuchos::rcp(new Epetra_Map(-1, num_all, 0, *mesh.getComm())),
...
{
  std::vector<Entity_kind> to_construct{ Entity_kind::CELL, Entity_kind::FACE, Entity_kind::NODE };
