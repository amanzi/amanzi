...
struct MeshFrameworkAlgorithms {
  ...
  virtual AmanziGeometry::Point getFaceNormal(
  ...
  getEdgeVector(const Mesh& mesh, const Entity_ID e, const Entity_ID n, int * const orientation) const; 

  virtual AmanziGeometry::Point
  getEdgeCentroid(const Mesh& mesh, const Entity_ID e) const; 

  virtual void getCellFacesAndBisectors(const Mesh& mesh, const Entity_ID cellid, cEntity_ID_View& faceids, cPoint_View * const bisectors) const; 
