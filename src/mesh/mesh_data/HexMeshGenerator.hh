 ...
 * - Map_ptr_types for global ID's can either be 0-based or 1-based
 * 
 */
class HexMeshGenerator
{
public:
  ...
  HexMeshGenerator(const Comm_ptr_type& comm_, 
  ...
  /// (Collective) Generate a Map_ptr_type for the cells
  Map_ptr_type cellmap(bool onebased = false);

  /// (Collective) Generate a Map_ptr_type for the vertexes
  Map_ptr_type vertexmap(bool onebased = false);
...
protected:
  ...
  Comm_ptr_type comm_;;      /**< The parallel environment */
