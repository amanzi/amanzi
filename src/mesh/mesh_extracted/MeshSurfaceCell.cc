...
// Get nodes of a cell
void
MeshSurfaceCell::getCellNodes(const Entity_ID cellid, cEntity_ID_View& nodeids) const
{
...
// In 2D, nfnodes is 2
void
MeshSurfaceCell::getFaceNodes(const Entity_ID faceid, cEntity_ID_View& nodeids) const
{
