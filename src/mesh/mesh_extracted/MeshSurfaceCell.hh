...
class MeshSurfaceCell : public Mesh {
 public:
  ...
  virtual Cell_type cell_get_type(const Entity_ID cellid) const override { return cell_type_; }
  ...
  // Epetra maps
  //------------
  virtual const Epetra_Map& cell_map(bool include_ghost) const override { return *cell_map_; }
  ...
  virtual const Epetra_Map& node_map(bool include_ghost) const override { return *face_map_; }
  ...
  virtual unsigned int get_set_size(const std::string& setname,
