...
TEST(SURFACE_COLUMN_MESH_3D)
{
  ...
  col_surf.get_set_entities_and_vofs("surface", AmanziMesh::CELL,
                                     AmanziMesh::Parallel_type::OWNED,
                                     &cells_in_surf, NULL);
  ...
  col_surf.get_set_entities_and_vofs("surface_domain", AmanziMesh::CELL,
                                     AmanziMesh::Parallel_type::OWNED,
...
TEST(SURFACE_COLUMN_MESH_3D_UNSTRUCTURED)
{
  ...
  Teuchos::RCP<AmanziGeometry::RegionLabeledSet> r0 =
      Teuchos::rcp(new AmanziGeometry::RegionLabeledSet("surface", -1, "FACE",
  ...
  CHECK_EQUAL(1, colmesh->get_set_size("surface",AmanziMesh::FACE, AmanziMesh::Parallel_type::ALL));
...
TEST(SURFACE_COLUMN_MESH_3D_UNSTRUCTURED_SETS)
{
  ...
  CHECK_EQUAL(9, mesh->get_set_size("Top Surface",AmanziMesh::FACE, AmanziMesh::Parallel_type::ALL));
  CHECK_EQUAL(1, mesh->build_columns());
  ...
  CHECK_EQUAL(1, colmesh->get_set_size("Top Surface",AmanziMesh::FACE, AmanziMesh::Parallel_type::ALL));
  CHECK_EQUAL(1, colmesh->get_set_size("Region 1",AmanziMesh::CELL, AmanziMesh::Parallel_type::ALL));
  ...
  AmanziMesh::Entity_ID_List cells_in_surf;
  col_surf.get_set_entities_and_vofs("Top Surface", AmanziMesh::CELL,
                                     AmanziMesh::Parallel_type::OWNED,
                                     &cells_in_surf, NULL);
  CHECK_EQUAL(1, cells_in_surf.size());
  CHECK_EQUAL(0, cells_in_surf[0]);
  ...
  col_surf.get_set_entities_and_vofs("Region 1", AmanziMesh::CELL,
                                     AmanziMesh::Parallel_type::OWNED,
                                     &cells_in_surf2, NULL);
  CHECK_EQUAL(1, cells_in_surf.size());
  CHECK_EQUAL(0, cells_in_surf[0]);
