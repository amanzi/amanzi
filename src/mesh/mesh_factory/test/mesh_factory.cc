...
SUITE(MeshFramework)
{
  ...
  TEST(Generate2D)
  {
    ...
    CHECK_THROW(mesh = meshfactory.create(x0, y0, x1, y1, nx, ny), Amanzi::AmanziMesh::Message);
    mesh.reset();
  ...
  TEST(ParameterGenerate3)
  {
    ...
    if (parallel) {
      CHECK_THROW(mesh = meshfactory.create(parameter_list), Amanzi::AmanziMesh::Message);
      mesh.reset();
    } else {
  ...
  TEST(ReadSimple)
  {
    ...
    pref.push_back(Amanzi::AmanziMesh::Framework::SIMPLE);
    meshfactory.set_preference(pref);
    CHECK_THROW(mesh = meshfactory.create(BOGUS_TEST_FILE), Amanzi::AmanziMesh::Message);
    CHECK_THROW(mesh = meshfactory.create(MOAB_TEST_FILE), Amanzi::AmanziMesh::Message);
    CHECK_THROW(mesh = meshfactory.create(EXODUS_TEST_FILE), Amanzi::AmanziMesh::Message);
    CHECK_THROW(mesh = meshfactory.create(NEMESIS_TEST_FILE), Amanzi::AmanziMesh::Message);
  }
  ...
  TEST(Extract3)
  {
    ...
    if (parallel) {
      ...
      auto mesh_cache = Teuchos::rcp(new Amanzi::AmanziMesh::Mesh(
        mesh, Teuchos::rcp(new Amanzi::AmanziMesh::MeshFrameworkAlgorithms()), Teuchos::null));
      CHECK_THROW(newmesh = meshfactory.create(
                    mesh_cache, ids, Amanzi::AmanziMesh::Entity_kind::FACE, flatten),
                  Amanzi::AmanziMesh::Message);
    }
    ...
    if (Amanzi::AmanziMesh::framework_enabled(Amanzi::AmanziMesh::Framework::MSTK)) {
      ...
      auto mesh_cache = Teuchos::rcp(new Amanzi::AmanziMesh::Mesh(
        mesh, Teuchos::rcp(new Amanzi::AmanziMesh::MeshFrameworkAlgorithms()), Teuchos::null));
      newmesh =
        meshfactory.create(mesh_cache, ents, Amanzi::AmanziMesh::Entity_kind::FACE, flatten);
