...
struct MeshLogicalAlgorithms : public MeshFrameworkAlgorithms {
  ...
  virtual Point_List
  computeBisectors(const Mesh& mesh, const Entity_ID c, const Entity_ID_View& faces) const override;
};
...
class MeshLogical : public MeshFramework {
 ...
 protected:
  ...
  RaggedArray<Entity_ID> cell_face_ids_;
  RaggedArray<int> cell_face_dirs_;
