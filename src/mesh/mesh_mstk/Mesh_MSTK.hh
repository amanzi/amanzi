...
class Mesh_MSTK : public MeshFramework {
 public:
  ...
  virtual std::size_t getNumEntities(const Entity_kind kind, const Parallel_kind ptype) const override;
  // Get parallel type of entity
  virtual Parallel_kind getEntityPtype(const Entity_kind kind, const Entity_ID entid) const override;
  ...
  virtual void getCellEdges(const Entity_ID cellid,
                  Entity_ID_View& edgeids) const override;
  ...
  virtual void getFaceEdgesAndDirs(const Entity_ID cellid,
                           ...
                           Entity_Direction_View * const edgedirs) const override;
  ...
  virtual void getEdgeNodes(const Entity_ID edgeid,
                          Entity_ID_View& nodes) const override;
  ...
  virtual void getSetEntities(const AmanziGeometry::RegionLabeledSet& region,
          ...
          const Parallel_kind ptype,
          Entity_ID_View& entids) const override;
...
inline
Parallel_kind Mesh_MSTK::getEntityPtype(const Entity_kind kind, const Entity_ID entid) const {
  MEntity_ptr ment;
