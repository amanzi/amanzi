...
class Mesh_MSTK : public MeshFramework {
 public:
  ...
  // Get edges of a cell
  virtual void getCellEdges(const Entity_ID cellid, Entity_ID_List& edgeids) const override;
  ...
  virtual void getEdgeNodes(const Entity_ID edgeid, Entity_ID_List& nodes) const override;
