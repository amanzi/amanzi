...
class Mesh_MSTK : public MeshFramework {
 public:
  ...
  // Get edges of a cell
  virtual void getCellEdges(const Entity_ID cellid, cEntity_ID_View& edgeids) const override;
  ...
  virtual void getEdgeNodes(const Entity_ID edgeid, cEntity_ID_View& nodes) const override;
 ...
 private:
  ...
  int generate_regular_mesh_(Mesh_ptr mesh,
                             double x0,
                             double y0,
                             double z0,
                             double x1,
                             ...
                             int nz);
  int
  generate_regular_mesh_(Mesh_ptr mesh, double x0, double y0, double x1, double y1, int nx, int ny);
...
inline Parallel_kind
Mesh_MSTK::getEntityPtype(const Entity_kind kind, const Entity_ID entid) const
{
  MEntity_ptr ment;
