...
//--------------------------------------
// Have to define this dummy routine because we are not able to eliminate the
// need in FrameworkTraits.cc which uses boost functionality extensively.
// Yeah this is bad and defeats the whole point of the traits thing.
//--------------------------------------
...
//--------------------------------------
Mesh_simple::Mesh_simple(const Comm_ptr_type& comm,
...
{  
  Exceptions::amanzi_throw(Errors::Message("Construction of new mesh from an existing mesh not yet implemented in the Simple mesh framework\n"));
}
