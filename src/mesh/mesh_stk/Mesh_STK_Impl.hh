...
class Mesh_STK_Impl {
 ...
 public:
  ...
  const Epetra_MpiComm      *comm_unicator () const { return comm_unicator_; }
  bool                       consistent   () const { return consistent_; }
  unsigned int               rank_id      () const { return comm_unicator_->MyPID (); }
 ...
 private:
  ...
  const Epetra_MpiComm *comm_unicator_;
