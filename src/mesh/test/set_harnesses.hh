...
testHexMeshSets3x3x3(const Teuchos::RCP<Mesh_type>& mesh, bool labeled, Framework f)
{
  ...
  for (const auto& r : *gm) {
    ...
    if (r_name == "Entire Mesh") {
      ...
      int n_ents =
        mesh->getSetSize(r_name, AmanziMesh::Entity_kind::CELL, AmanziMesh::Parallel_type::OWNED);
      ...
      CHECK_EQUAL(
        ...
        mesh->getSetSize(r_name, AmanziMesh::Entity_kind::CELL, AmanziMesh::Parallel_type::ALL));
      ...
      if (labeled) {
        ...
        ents = mesh->getSetEntities(
          r_name, AmanziMesh::Entity_kind::CELL, AmanziMesh::Parallel_type::ALL);
      ...
      AmanziMesh::Entity_ID_List ents;
      ents =
        mesh->getSetEntities(r_name, AmanziMesh::Entity_kind::CELL, AmanziMesh::Parallel_type::ALL);
      for (const auto& e : ents) {
        auto cc = mesh->getCellCentroid(e);
      ...
      // AmanziMesh::Entity_ID_List ents;
      // ents = mesh->getSetEntities(r_name, AmanziMesh::Entity_kind::CELL, AmanziMesh::Parallel_type::ALL);
      ...
      if (labeled || r_name == "Top Face Plane") {
        int n_ents =
          mesh->getSetSize(r_name, AmanziMesh::Entity_kind::FACE, AmanziMesh::Parallel_type::OWNED);
        CHECK_CLOSE_SUMALL(3 * 3, n_ents, *mesh->getComm());

        AmanziMesh::Entity_ID_List ents;
        ents = mesh->getSetEntities(
          r_name, AmanziMesh::Entity_kind::FACE, AmanziMesh::Parallel_type::ALL);
        for (const auto& e : ents) {
      ...
      AmanziMesh::Entity_ID_List ents;
      ents =
        mesh->getSetEntities(r_name, AmanziMesh::Entity_kind::FACE, AmanziMesh::Parallel_type::ALL);
      for (const auto& e : ents) {
        auto fc = mesh->getFaceCentroid(e);
      ...
      int n_ents =
        mesh->getSetSize(r_name, AmanziMesh::Entity_kind::NODE, AmanziMesh::Parallel_type::OWNED);
      CHECK_CLOSE_SUMALL(4 * 4, n_ents, *mesh->getComm());

      AmanziMesh::Entity_ID_List ents;
      ents =
        mesh->getSetEntities(r_name, AmanziMesh::Entity_kind::NODE, AmanziMesh::Parallel_type::ALL);
      for (const auto& e : ents) {
      ...
      CHECK_THROW(
        mesh->getSetSize(r_name, AmanziMesh::Entity_kind::CELL, AmanziMesh::Parallel_type::ALL),
        Errors::Message);
      // n_ents = mesh->getSetSize(r_name, AmanziMesh::Entity_kind::CELL, AmanziMesh::Parallel_type::ALL);
      // CHECK_CLOSE_SUMALL(0, n_ents, *mesh->getComm());
