...
// Last Change: Mon Mar 14 16:38:48 2011 by William A. Perkins <d3g096@PE10900.pnl.gov>
// -------------------------------------------------------------
...
namespace Mesh {
  ...
  framework_read(const Epetra_Comm&, const Framework& f, const std::string& fname);
  ...
  /// Generate a mesh
  extern Teuchos::RCP<Mesh_maps_base> 
  framework_generate(const Epetra_Comm&, const Framework& f, 
