#ifndef AMANZI_OBSERVABLELINESEGMENTAQUEOUS_HH
#define AMANZI_OBSERVABLELINESEGMENTAQUEOUS_HH
...
class ObservableLineSegmentAqueous : public ObservableAqueous, public ObservableLineSegment{
  ...
  void ObservableLineSegmentAqueous::ComputeObservation(State& S, double* value, double* volume){
