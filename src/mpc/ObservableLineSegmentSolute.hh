#ifndef AMANZI_OBSERVABLELINESEGMENTSOLUTE_HH
#define AMANZI_OBSERVABLELINESEGMENTSOLUTE_HH
...
class ObservableLineSegmentSolute : public ObservableSolute, public ObservableLineSegment{
  ...
  void ObservableLineSegmentSolute::ComputeObservation(State& S, double* value, double* volume){
