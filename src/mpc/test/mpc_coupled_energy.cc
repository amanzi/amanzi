...
TEST(MPC_DRIVER_ENERGY_MATRIX_FRACTURE)
{
  ...
  auto mesh = factory.create(400.0, 0.0, 0.0, 600.0, 100.0, 1000.0, 20, 5, 100, true, true);
  ...
  ncells = mesh_fracture->num_entities(AmanziMesh::CELL, AmanziMesh::Parallel_type::OWNED);
