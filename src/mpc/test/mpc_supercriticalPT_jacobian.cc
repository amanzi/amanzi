...
TEST(MPC_DRIVER_THERMAL_RICHARDS_JACOBIAN)
{
  ...
  Teuchos::RCP<Mesh> mesh = meshfactory.create(0.0, 0.0, 10.0, 3.0, 5, 3);
  ...
  std::cout<<"nfaces "<<nfaces<<" ncells "<<ncells<<"\n";
  ...
  for (int i0 = 0; i0 < 2; ++i0) {
    for (int j0 = 0; j0 < 2; ++j0) {
      ...
      // if (i0==0 && j0==1){
      //   std::cout<<"f0\n";
      //   std::cout<<*u0->SubVector(j0)->Data()->ViewComponent("cell")<<"\n";
      //   std::cout<<*u0->SubVector(0) ->Data()->ViewComponent("cell")<<"\n";
      //   std::cout<<*f0->SubVector(i0)->Data()->ViewComponent("cell")<<"\n";
      //   std::cout<<*f0->SubVector(i0)->Data()->ViewComponent("face")<<"\n";
      // }
      ...
      for (int ncol = 0; ncol < nJ; ++ncol) {
        ...
        // if (i0==0 && j0==1 && v==5 && ncol==22){
        //   std::cout<<u1_v<<"\n";
        //   std::cout<<*u1->SubVector(j0)->Data()->ViewComponent("face")<<"\n";
        //   std::cout<<*f0->SubVector(i0)->Data()->ViewComponent("cell")<<"\n";
        //   std::cout<<*f0->SubVector(i0)->Data()->ViewComponent("face")<<"\n";
        // }
      ...
      //     std::cout<<"Jsbrow: "<<i<<" ";
      //     for (int j = 0; j < nJ; ++j) {
      //       if (abs(Jsub(i, j)) > 1e-9) std::cout<<j<<" "<<Jsub(i, j)<<" ";
      //     }
      //     std::cout<<"\n";
      //     std::cout<<"Jfdrow: "<<i<<" ";
      //     for (int j = 0; j < nJ; ++j) {
      //       if (abs(Jfd(i, j)) > 1e-9) std::cout<<j<<" "<<Jfd(i, j)<<" ";
      //     }
      //     std::cout<<"\n";
      //   }
      // }
      ...
      int s1(0), s2(0);
      //if (i0 == 0 && j0 == 0) std::cout << Jfd.SubMatrix(s1, s1 + 5, s2, s2 + 5) << std::endl;
