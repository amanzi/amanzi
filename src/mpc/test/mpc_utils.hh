...
****************************************************************** */
void
CreateApertureFile(int ncells, double time)
{
  ...
  hid_t dataset0 =
    H5Dcreate(gout, "0", H5T_NATIVE_DOUBLE, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
  H5Dwrite(dataset0, H5T_NATIVE_DOUBLE, H5S_ALL, H5S_ALL, H5P_DEFAULT, aperture0.data());
  H5Dclose(dataset0);

  hid_t dataset1 =
    H5Dcreate(gout, "1", H5T_NATIVE_DOUBLE, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
  ...
  hid_t time_dataset = H5Dcreate(
    hout, "time", H5T_NATIVE_DOUBLE, time_dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
