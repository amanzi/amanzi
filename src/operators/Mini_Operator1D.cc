 ...
 ****************************************************************** */
void
Mini_Operator1D::AddAccumulationTerm(double s0, double s1, double dt,
 ...
 ****************************************************************** */
void
Mini_Operator1D::Apply(const WhetStone::DenseVector& v,
 ...
 ****************************************************************** */
void
Mini_Operator1D::ApplyInverse(const WhetStone::DenseVector& rhs,
                              WhetStone::DenseVector& sol)
{
  int nrhs(1), info;
  int n = diag_.NumRows();
  ...
  sol = rhs;
  WhetStone::DGTSV_F77(
    &n, &nrhs, dl, diag_.Values(), dr, sol.Values(), &n, &info);
}
