...
// coefficient type
enum class Coef_kind { CONSTANT = 0,  // includes tensorial coefficients
  POLYNOMIAL,
  VECTOR_POLYNOMIAL,
...
// Schema enum defines a combination of:
//  1. what DOFs are used
//  2. what the base element over which local
//     matrices are formed
//
