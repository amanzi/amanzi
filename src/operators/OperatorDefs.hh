...
const int OPERATOR_UPWIND_FLUX = 1;
const int OPERATOR_UPWIND_CONSTANT_VECTOR = 2;
const int OPERATOR_UPWIND_ARITHMETIC_AVERAGE = 3;
const int OPERATOR_UPWIND_AMANZI_ARTIFICIAL_DIFFUSION = 4;
const int OPERATOR_UPWIND_AMANZI_MFD = 5;
