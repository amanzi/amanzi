...
PDE_DiffusionMFDwithGravity::AddGravityToRHS_()
{
  if (global_op_->rhs()->hasComponent("face")) {
    ...
    { // context for views
      ...
      Kokkos::parallel_for(
        "PDE_DiffusionMFDwithGravity::AddGravityToRHS_", ncells_owned, KOKKOS_LAMBDA(const int& c) {
                                        ...
                                        const Teuchos::Ptr<CompositeVector>& flux)
{
  ...
  { // context for views
    ...
    Kokkos::parallel_for(
      "PDE_DiffusionMFDwithGravity::UpdateFlux", ncells_owned, KOKKOS_LAMBDA(const int& c) {
...

  {
    ...
    Kokkos::parallel_for(
      "PDE_DiffusionMFDwithGravity::UpdateFlux Average", nfaces_owned, KOKKOS_LAMBDA(const int& f) {
...
****************************************************************** */
void
PDE_DiffusionMFDwithGravity::Init()
{
