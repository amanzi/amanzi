                                              ...
                                              const Teuchos::Ptr<const CompositeVector>& u)
{
  ...
  AmanziMesh::Entity_ID_View cells, cells_tmp;
    ...
    for (int n = 0; n < nfaces; ++n) {
      ...
      if (gg < 0.0) {
        ...
        for (int i = 1; i < dim_; i++) {
          ...
          cells_tmp = mesh_->getFaceCells(f1, AmanziMesh::Parallel_kind::ALL);
                                                           ...
                                                           CompositeVector& flux_cv)
{
  ...
  double gamma, tmp;
  std::vector<int> dirs;
  AmanziMesh::Entity_ID_View cells, cells_tmp, faces;
...
****************************************************************** */
int
PDE_DiffusionNLFVwithBndFaces::OrderCellsByGlobalId_(const AmanziMesh::Entity_ID_View& cells,
                                                     int& c1,
                                                     int& c2)
{
  c1 = cells[0];
