...
class AnalyticElasticityBase {
 public:
  AnalyticElasticityBase(Teuchos::RCP<const Amanzi::AmanziMesh::Mesh> mesh) : mesh_(mesh) {
    nnodes_owned = mesh_->getNumEntities(Amanzi::AmanziMesh::NODE, Amanzi::AmanziMesh::Parallel_kind::OWNED);
    ncells_owned = mesh_->getNumEntities(Amanzi::AmanziMesh::CELL, Amanzi::AmanziMesh::Parallel_kind::OWNED);

    nnodes_wghost = mesh_->getNumEntities(Amanzi::AmanziMesh::NODE, Amanzi::AmanziMesh::Parallel_kind::ALL);
    ncells_wghost = mesh_->getNumEntities(Amanzi::AmanziMesh::NODE, Amanzi::AmanziMesh::Parallel_kind::ALL);
  };
