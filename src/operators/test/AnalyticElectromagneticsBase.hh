...
class AnalyticElectromagneticsBase : public Amanzi::WhetStone::WhetStoneFunction {
 public:
  AnalyticElectromagneticsBase(Teuchos::RCP<const Amanzi::AmanziMesh::Mesh> mesh)
    : mesh_(mesh) {};
  ...
  // -- analytic solution E
  virtual Amanzi::AmanziGeometry::Point electric_exact(const Amanzi::AmanziGeometry::Point& p,
                                                       double t) = 0;
  virtual Amanzi::AmanziGeometry::Point magnetic_exact(const Amanzi::AmanziGeometry::Point& p,
                                                       double t) = 0;
  // -- source term
  ...
  void ComputeFaceError(Epetra_MultiVector& u,
                        ...
                        double& l2_err,
                        double& inf_err);
  void ComputeEdgeError(Epetra_MultiVector& u,
                        double t,
                        double& unorm,
                        double& l2_err,
                        double& inf_err);
  void ComputeNodeError(Epetra_MultiVector& u,
                        double t,
                        double& unorm,
                        double& l2_err,
                        double& inf_err);
