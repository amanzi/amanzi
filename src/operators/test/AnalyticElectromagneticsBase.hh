...
class AnalyticElectromagneticsBase : public Amanzi::WhetStone::WhetStoneFunction {
 public:
  ...
  void
  ComputeEdgeError(Epetra_MultiVector& u, double t, double& unorm, double& l2_err, double& inf_err);
  void
  ComputeNodeError(Epetra_MultiVector& u, double t, double& unorm, double& l2_err, double& inf_err);
