...
TEST(CURL_CURL_HIGH_ORDER) {
  ...
  CurlCurl_VEM<AnalyticElectromagnetics02>(0, "Nedelec serendipity", 1, 1e+2, "test/hexes4.exo");
  // CurlCurl_VEM<AnalyticElectromagnetics02>(0, "Nedelec serendipity", 1, 1e+2, "test/hexes16.exo");
/*
...
L2(e)= 0.000289011  Inf(e)= 0.000289035  itr=456  size=615520
  ...
  CurlCurl_VEM<AnalyticElectromagnetics02>(7, "Nedelec serendipity", 0, 2e-3);
*/
}
