                                            ...
                                            int nx, int ny)
{
  ...
  if (u.hasComponent("boundary_face")) {
    int nboundary_faces = mesh->getNumEntities(AmanziMesh::BOUNDARY_FACE,
                                            ...
                                            int nx, int ny, bool write_matrix)
{
  ...
  if (u.hasComponent("boundary_face")) {
    int nboundary_faces = mesh->getNumEntities(AmanziMesh::BOUNDARY_FACE, AmanziMesh::Parallel_kind::OWNED);
    Epetra_MultiVector& u_f = *u.viewComponent("boundary_face", false);
