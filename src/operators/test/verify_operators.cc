...
TEST(Verify_Mesh_and_Operators)
{
  ...
  plist->sublist("solvers")
    .sublist("GMRES")
    .set<std::string>("iterative method", "gmres")
  ...
  plist->sublist("solvers")
    .sublist("Amesos1: KLU")
    .set<std::string>("direct method", "amesos")
    .sublist("amesos parameters")
    .set<std::string>("solver name", "Klu")
    .set<int>("amesos version", 1);

  plist->sublist("solvers")
    .sublist("Amesos2: Basker")
    .set<std::string>("direct method", "amesos")
    .sublist("amesos parameters")
  ...
  plist->sublist("preconditioners")
    .sublist("diagonal")
    .set<std::string>("preconditioning method", "diagonal")
    .sublist("diagonal parameters");
  ...
  plist->sublist("preconditioners")
    .sublist("Trilinos: ML")
    .set<std::string>("preconditioning method", "ml")
  ...
  plist->sublist("preconditioners")
    .sublist("Trilinos: MueLu")
    .set<std::string>("preconditioning method", "muelu")
  ...
  */
  ...
  if (MyPID == 0) {
    ...
    else plist->sublist("preconditioners").sublist(prec_solver).print(std::cout, 0, true, false);
  }
