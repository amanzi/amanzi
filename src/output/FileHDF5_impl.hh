...
FileHDF5::writeView(const std::string& var_path,
                    view_type view)
{
  std::array<GO, 2> globaldims = { static_cast<GO>(view.extent(0)), static_cast<GO>(view.extent(1)) };
                    ...
                    std::array<GO,2> dims)
{
  ...
  using value_type = typename Kokkos::View<scalar_type**, Kokkos::LayoutRight, Kokkos::HostSpace>::non_const_value_type;
