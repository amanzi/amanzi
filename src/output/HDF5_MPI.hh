...
class HDF5_MPI {
 public:
  ...
  void writeNodeDataReal(const Vector_type &x, const std::string& varname);
  void writeNodeDataInt(const Vector_type &x, const std::string& varname);

  // Write cell data to HDF5 data file.
  void writeCellDataReal(const Vector_type &x, const std::string& varname);
  void writeCellDataInt(const Vector_type &x, const std::string& varname);
  
  // Write array data to HDF5 data file. Meant for Restart ONLY not Viz!
  void writeDataReal(const Vector_type &x, const std::string& varname);
  void writeDataInt(const Vector_type &x, const std::string& varname);
  
  // Read array data from HDF5 data file.
  bool readData(Vector_type &x, const std::string varname);
 ...
 private:
  ...
  void writeFieldData_(const Vector_type &x, const std::string& varname, datatype_t type, std::string loc);
  bool readFieldData_(Vector_type &x, const std::string& varname, datatype_t type);
