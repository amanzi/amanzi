...
class Input {
 public:
  ...
  virtual void read(const Teuchos::ParameterList& attrs, CompositeVector_<int_type>& vec) const
  {
    readCompositeVector_(attrs, vec);
  }
  virtual void read(const Teuchos::ParameterList& attrs, CompositeVector_<double_type>& vec) const
  {
    readCompositeVector_(attrs, vec);
  }
 ...
 protected:
  ...
  template <typename Scalar>
  void
  readCompositeVector_(const Teuchos::ParameterList& attrs, CompositeVector_<Scalar>& vec) const
  {
