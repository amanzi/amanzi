...
class OutputDomainSet : public Output {
 ...
 protected:
  ...
  mutable std::map<std::string,
                   std::pair<Teuchos::RCP<MultiVector_type>, std::vector<std::string>>> lifted_vectors_;
  mutable std::vector<std::string> lifted_vector_names_;
  mutable std::map<std::string,
                   std::pair<Teuchos::RCP<IntMultiVector_type>, std::vector<std::string>>> lifted_int_vectors_;
