...
TEST(GMV)
{
  ...
  auto node_quantity =
    Teuchos::rcp(new Vector_type(mesh->getMap(Amanzi::AmanziMesh::Entity_kind::NODE, false)));
  ...
  auto cell_quantity =
    Teuchos::rcp(new Vector_type(mesh->getMap(Amanzi::AmanziMesh::Entity_kind::CELL, false)));
