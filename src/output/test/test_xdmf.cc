...
TEST(XDMF) {
  ...
  auto node_quantity = Teuchos::rcp(new Amanzi::Vector_type(Mesh->node_map(false)));
  ...
  auto cell_quantity = Teuchos::rcp(new Amanzi::Vector_type(Mesh->cell_map(false)));
  ...
  auto fake_pressure = Teuchos::rcp(new Amanzi::Vector_type(Mesh->cell_map(false)));
