...
#ifndef AMANZI_PK_DOMAIN_FUNCTION_CONCENTRATION_HH_
#define AMANZI_PK_DOMAIN_FUNCTION_CONCENTRATION_HH_
...
class PK_DomainFunctionConcentration : public FunctionBase, public Functions::UniqueMeshFunction {
 public:
  PK_DomainFunctionConcentration(const Teuchos::RCP<const AmanziMesh::Mesh>& mesh,
  ...
  ~PK_DomainFunctionConcentration(){};
...
template <class FunctionBase>
void
PK_DomainFunctionConcentration<FunctionBase>::Init(const Teuchos::ParameterList& plist,
...
template <class FunctionBase>
void
PK_DomainFunctionConcentration<FunctionBase>::Compute(double t0, double t1)
{
