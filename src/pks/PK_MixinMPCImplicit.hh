...
// applies preconditioner to u and returns the result in Pu
template <class Base_t, class PK_Contained_t>
int PK_MixinMPCImplicit<Base_t, PK_Contained_t>::ApplyPreconditioner(
...
// computes a norm on u-du and returns the result
template <class Base_t, class PK_Contained_t>
double PK_MixinMPCImplicit<Base_t, PK_Contained_t>::ErrorNorm(
...
// updates the preconditioner
template <class Base_t, class PK_Contained_t>
void PK_MixinMPCImplicit<Base_t, PK_Contained_t>::UpdatePreconditioner(
...
// override final with the actual admissibility check
template <class Base_t, class PK_Contained_t>
bool PK_MixinMPCImplicit<Base_t, PK_Contained_t>::IsAdmissible(
...
// modified, false if not
template <class Base_t, class PK_Contained_t>
bool PK_MixinMPCImplicit<Base_t, PK_Contained_t>::ModifyPredictor(
...
// update the continuation parameter
template <class Base_t, class PK_Contained_t>
void PK_MixinMPCImplicit<Base_t, PK_Contained_t>::UpdateContinuationParameter(
    double lambda) {
  for (auto &pk : sub_pks_)
    pk->UpdateContinuationParameter(lambda);
}
...
// state.
template <class Base_t, class PK_Contained_t>
void PK_MixinMPCImplicit<Base_t, PK_Contained_t>::ChangedSolution() {
  for (auto &pk : sub_pks_)
    pk->ChangedSolution();
}
