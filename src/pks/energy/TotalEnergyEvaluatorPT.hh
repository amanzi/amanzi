...
#ifndef AMANZI_ENERGY_TOTAL_ENERGY_EVALUATOR_PT_HH_
#define AMANZI_ENERGY_TOTAL_ENERGY_EVALUATOR_PT_HH_
...
class TotalEnergyEvaluatorPT
  : public EvaluatorSecondaryMonotype<CompositeVector, CompositeVectorSpace> {
 public:
  explicit TotalEnergyEvaluatorPT(Teuchos::ParameterList& ee_plist);
  TotalEnergyEvaluatorPT(const TotalEnergyEvaluatorPT& other);
