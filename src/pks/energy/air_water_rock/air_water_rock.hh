...
class Energy_AirWaterRock : public PK, public BDFFnBase {

public:

  Energy_AirWaterRock(Teuchos::ParameterList& plist, Teuchos::RCP<State>& S,
                      Teuchos::RCP<TreeVector>& soln);

  // Energy_AirWaterRock is a PK
...
private:
  ...
  // operators
  Teuchos::RCP<Advection> advection_;

  // time integration
  Teuchos::RCP<ImplicitTIBDF2> time_stepper_;
  double atol_;
  double rtol_;
}
