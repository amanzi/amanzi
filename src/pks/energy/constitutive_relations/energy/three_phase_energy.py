...
import sympy
phi, sl, nl, ul, si, ni, ui, sg, ng, ug, rho_r, ur, cv = sympy.var("phi, sl, nl, ul, si, ni, ui, sg, ng, ug, rho_r, ur, cv")
expression = (phi*(sl*nl*ul + si*ni*ui + sg*ng*ug) + (1-phi)*rho_r*ur) * cv;
