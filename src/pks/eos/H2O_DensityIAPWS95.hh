...
#ifndef AMANZI_EOS_H2O_DENSITY_IAPWS95_HH_
#define AMANZI_EOS_H2O_DENSITY_IAPWS95_HH_
...
class H2O_DensityIAPWS95 : public EOS_Density {
 public:
  explicit H2O_DensityIAPWS95(Teuchos::ParameterList& eos_plist);
 ...
 private:
  ...
  static Utils::RegisteredFactory<EOS_Density, H2O_DensityIAPWS95> reg_;
};
