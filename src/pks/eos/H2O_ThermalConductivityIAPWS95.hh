...
#ifndef AMANZI_EOS_H2O_THERMAL_CONDUCTIVITY_IAPWS95_HH_
#define AMANZI_EOS_H2O_THERMAL_CONDUCTIVITY_IAPWS95_HH_
...
class H2O_ThermalConductivityIAPWS95 : public EOS_ThermalConductivity {
 public:
  explicit H2O_ThermalConductivityIAPWS95(Teuchos::ParameterList& plist);
  virtual ~H2O_ThermalConductivityIAPWS95() {};
 ...
 private:
  Teuchos::RCP<IAPWS95> eos_;
  static Utils::RegisteredFactory<EOS_ThermalConductivity, H2O_ThermalConductivityIAPWS95> reg_;
};
