...
Utils::RegisteredFactory<EOS_Density, H2O_DensityFEHM> H2O_DensityFEHM::factory_("liquid water FEHM");
Utils::RegisteredFactory<EOS_Density, H2O_DensityTabular> H2O_DensityTabular::factory_("liquid water tabular");

Utils::RegisteredFactory<EOS_SaturatedVaporPressure, H2O_SaturatedVaporPressure> H2O_SaturatedVaporPressure::factory_("water vapor over water/ice");

Utils::RegisteredFactory<EOS_Viscosity, H2O_Viscosity> H2O_Viscosity::factory_("liquid water 0-30C");
