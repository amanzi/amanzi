...
// FlowBoundaryFunction<Value_Type>::FlowBoundaryFunction<Value_Type>(const Teuchos::ParameterList& plist)
// {
//   rainfall_ = false;
...
**************************************************************** */
// template <class Value_Type>
// void FlowBoundaryFunction<Value_Type>::ComputeSubmodel(
...
//   void FlowBoundaryFunction<ValueType>::CalculateShiftWaterTable_(
//     const Teuchos::RCP<const AmanziMesh::Mesh>& mesh,
...
// ****************************************************************** */
// template <class Value_Type>
// void FlowBoundaryFunction<Value_Type>::set_intersection_(
