...
class FlowBoundaryFunction : public PK_DomainFunction<ValueType> {
 public:
...
template <class ValueType>
FlowBoundaryFunction<ValueType>::FlowBoundaryFunction(const Teuchos::ParameterList& plist){
  rainfall_ = false;
...
template <class ValueType>
void FlowBoundaryFunction<ValueType>::ComputeSubmodel(const Teuchos::RCP<const AmanziMesh::Mesh>& mesh)
{
...
template <class ValueType>
void FlowBoundaryFunction<ValueType>::CalculateShiftWaterTable_(const Teuchos::RCP<const AmanziMesh::Mesh>& mesh,
                                                                const std::string& region)
{
...
template <class ValueType>
void FlowBoundaryFunction<ValueType>::set_intersection_(const std::vector<AmanziMesh::Entity_ID>& v1,
                                                        const std::vector<AmanziMesh::Entity_ID>& v2, 
                                                        std::vector<AmanziMesh::Entity_ID>* vv)
{
