...
typedef std::vector<Teuchos::RCP<MultiscaleFlowPorosity> > MsPList;
typedef std::pair<Teuchos::RCP<Functions::MeshPartition>, MsPList> MultiscaleFlowPorosityPartition;
