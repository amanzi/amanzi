...
#include "VWContentEvaluator_VariableDensity.hh"
...
* Constructor.
****************************************************************** */
VWContentEvaluator_VariableDensity::VWContentEvaluator_VariableDensity(Teuchos::ParameterList& plist) :
...
* Initialization.
****************************************************************** */
void VWContentEvaluator_VariableDensity::Init_()
{
...
****************************************************************** */
void VWContentEvaluator_VariableDensity::EvaluateField_(
...
* Required member: field calculation.
****************************************************************** */
void VWContentEvaluator_VariableDensity::EvaluateFieldPartialDerivative_(
