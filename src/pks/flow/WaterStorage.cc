...
****************************************************************** */
void
WaterStorage::Evaluate_(const State& S, const std::vector<CompositeVector*>& results)
{
...
****************************************************************** */
void
WaterStorage::EvaluatePartialDerivative_(const State& S,
                                         const Key& wrt_key,
                                         const Tag& wrt_tag,
