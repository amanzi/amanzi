...
#ifndef AMANZI_FLOWRELATIONS_MANNING_CONDUCTIVITY_SUBGRID_MODEL_
#define AMANZI_FLOWRELATIONS_MANNING_CONDUCTIVITY_SUBGRID_MODEL_

#include "Teuchos_ParameterList.hpp"
#include "overland_conductivity_subgrid_model.hh"

namespace Amanzi {
namespace Flow {

class ManningConductivitySubgridModel : public OverlandConductivitySubgridModel {
public:
  explicit
  ManningConductivitySubgridModel(Teuchos::ParameterList& plist);
