...
#ifndef AMANZI_FLOWRELATIONS_OVERLAND_CONDUCTIVITY_SUBGRID_MODEL_
#define AMANZI_FLOWRELATIONS_OVERLAND_CONDUCTIVITY_SUBGRID_MODEL_
...
class OverlandConductivitySubgridModel {
 public:
  virtual ~OverlandConductivitySubgridModel() = default;
...
//  virtual double Conductivity(double depth, double slope, double coef) = 0;
 // virtual double DConductivityDDepth(double depth, double slope, double coef) = 0;
  ...
  virtual double Conductivity(double depth, double slope, double coef, double d, double frac, double beta) =0;
//{
 //   return Conductivity(depth,slope,coef);
 // }
  virtual double DConductivityDDepth(double depth, double slope, double coef, double p, double frac, double beta) =0;
//{
