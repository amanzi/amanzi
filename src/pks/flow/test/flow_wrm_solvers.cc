...
TEST(VAN_GENUCHTEN_BRENT_AND_TOMS748)
{
  ...
  std::vector<int> itr2({ 12, 13, 13, 16, 16, 16, 16, 16, 18, 19, 16, 15, 17, 19, 19, 19, 19,
                          19, 19, 21, 19, 19, 19, 19, 20, 18, 18, 18, 18, 18, 18, 18, 18, 18,
                          18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 16, 16, 16, 16,
                          16, 17, 16, 16, 15, 15, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,
                          12, 12, 12, 11, 12, 11, 11, 12, 12, 11, 11, 11, 11, 14, 11, 11, 11 });
