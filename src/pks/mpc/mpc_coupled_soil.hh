...
#ifndef MPC_COUPLEDSOIL_HH_
#define MPC_COUPLEDSOIL_HH_
...
class MPCCoupledSoil : public StrongMPC<PK_PhysicalBDF_Default> {

 public:

  MPCCoupledSoil(Teuchos::ParameterList& pk_tree_list,
...
private:
  ...
  static RegisteredPKFactory<MPCCoupledSoil> reg_;
};
