...
* Constructor
******************************************************************* */
EnergyPHMatrixFracture_PK::EnergyPHMatrixFracture_PK(
...
******************************************************************* */
void
EnergyPHMatrixFracture_PK::Setup()
{
...
******************************************************************* */
void
EnergyPHMatrixFracture_PK::Initialize()
{
...
******************************************************************* */
bool
EnergyPHMatrixFracture_PK::AdvanceStep(double t_old, double t_new, bool reinit)
{
...
******************************************************************* */
void
EnergyPHMatrixFracture_PK::FunctionalResidual(double t_old,
                                              double t_new,
...
******************************************************************* */
void
EnergyPHMatrixFracture_PK::UpdatePreconditioner(double t, Teuchos::RCP<const TreeVector> u, double dt)
{
...
******************************************************************* */
int
EnergyPHMatrixFracture_PK::ApplyPreconditioner(Teuchos::RCP<const TreeVector> X,
