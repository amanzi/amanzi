...
class EnergyPHMatrixFracture_PK : public PK_MPCStrong<PK_BDF> {
 public:
  EnergyPHMatrixFracture_PK(Teuchos::ParameterList& pk_tree,
 ...
 private:
  ...
  static RegisteredPKFactory<EnergyPHMatrixFracture_PK> reg_;
};
