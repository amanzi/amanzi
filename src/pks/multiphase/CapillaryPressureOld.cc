...
****************************************************************** */
void CapillaryPressureOld::Init(Teuchos::ParameterList& plist)
{
  //atm_pressure = p0;
...
****************************************************************** */
void CapillaryPressureOld::Compute(const CompositeVector& saturation_water)
{
...
****************************************************************** */
void CapillaryPressureOld::ProcessParameterList_(Teuchos::ParameterList& plist)
{
