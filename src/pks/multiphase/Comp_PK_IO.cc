/*
  ...
  This routine implements various I/O components of Comp_PK 
*/
...
* on each processor.                                                     
****************************************************************** */
void Comp_PK::ProcessParameterList(Teuchos::ParameterList& plist)
{
  ...
  bc_mfw_ = bc_factory.CreateMolarFraction(bc_submodel_xw_, 1);
  bc_mfn_ = bc_factory.CreateMolarFraction(bc_submodel_xn_, 2);
  ...
  if (!plist.isSublist("source terms")) {
    Errors::Message msg;
    msg << "Comp_PK: problem does not have <source terms> list\n";
    Exceptions::amanzi_throw(msg);
  } else {
...
**************************************************************** */
void Comp_PK::ProcessSublistTimeInterval(
...
**************************************************************** */
void Comp_PK::ProcessSublistTimeIntegration(
...
**************************************************************** */
void Comp_PK::ProcessStringTimeIntegration(const std::string name, int* method)
{
  Errors::Message msg;
...
**************************************************************** */
std::string Comp_PK::FindStringPreconditioner(const Teuchos::ParameterList& list)
{   
  Errors::Message msg;
  std::string name; 
...
**************************************************************** */
std::string Comp_PK::FindStringLinearSolver(const Teuchos::ParameterList& list)
{   
  Errors::Message msg;
  std::string name; 
...
**************************************************************** */
void Comp_PK::ProcessStringErrorOptions(Teuchos::ParameterList& list, int* control)
{
  *control = 0;
...
****************************************************************** */
/*
void Comp_PK::AddSourceTerms(CompositeVector& rhs)
{
...
**************************************************************** */
void Comp_PK::ProcessStringSourceDistribution(const std::string name, int* method)
{
  if (name != "none") {
    Errors::Message msg;
    msg << "\n Comp_PK: \"source and sink distribution method\" is obsolete.\n"
...
**************************************************************** */
void Comp_PK::OutputTimeHistory(
