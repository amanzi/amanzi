/*
  ...
  This routine implements various I/O components of Phase1_PK 
*/
...
* on each processor.                                                     
****************************************************************** */
void Phase1_PK::ProcessParameterList(Teuchos::ParameterList& plist)
{
  ...
  if (!plist.isSublist("source terms")) {
    Errors::Message msg;
    msg << "Phase1_PK: problem does not have <source terms> list\n";
    Exceptions::amanzi_throw(msg);
  } else {
...
**************************************************************** */
/*
void Phase1_PK::ProcessSublistTimeInterval(
...
**************************************************************** */
/*
void Phase1_PK::ProcessSublistTimeIntegration(
...
**************************************************************** */
/*
void Phase1_PK::ProcessStringTimeIntegration(const std::string name, int* method)
{
  Errors::Message msg;
...
**************************************************************** */
/*
std::string Phase1_PK::FindStringPreconditioner(const Teuchos::ParameterList& list)
{   
  Errors::Message msg;
  std::string name; 
...
**************************************************************** */
/*
std::string Phase1_PK::FindStringLinearSolver(const Teuchos::ParameterList& list)
{   
  Errors::Message msg;
  std::string name; 
...
**************************************************************** */
/*
void Phase1_PK::ProcessStringErrorOptions(Teuchos::ParameterList& list, int* control)
{
  *control = 0;
...
****************************************************************** */
/*
void Phase1_PK::AddSourceTerms(CompositeVector& rhs)
{
...
**************************************************************** */
void Phase1_PK::ProcessStringSourceDistribution(const std::string name, int* method)
{
  if (name != "none") {
    Errors::Message msg;
    msg << "\n Phase1_PK: \"source and sink distribution method\" is obsolete.\n"
...
**************************************************************** */
/*
void Phase1_PK::OutputTimeHistory(
