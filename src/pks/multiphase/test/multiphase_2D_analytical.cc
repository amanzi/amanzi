...
/*
2 component (Hydrogen, Water), 2 phase with assumptions as in [Gharbia, Jaffre' 14]. 2D analytical solution not related to any physical scenario.
*/
...
run_test(const std::string& domain, const std::string& filename)
{
  ...
  if (MyPID == 0) std::cout << "Test: multiphase pk, 2D analytical solution"<<std::endl;
