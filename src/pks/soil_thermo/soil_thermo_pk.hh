...
*/
//! An advection-diffusion equation for temperature distribution in the soil.
...
#ifndef PKS_SOIL_THERMO_HH_
#define PKS_SOIL_THERMO_HH_
...
class Soil_Thermo_PK : public PK_PhysicalBDF_Default{

public:

  Soil_Thermo_PK(Teuchos::ParameterList& FElist,
             const Teuchos::RCP<Teuchos::ParameterList>& plist,
             const Teuchos::RCP<State>& S,
             const Teuchos::RCP<TreeVector>& solution);
  
  // Virtual destructor
  virtual ~Soil_Thermo_PK() {}

  // Soil_Thermo_PK is a PK
  // -- Setup data
 ...
 protected:
  ...
  // Standard methods
  virtual void SetupSoilThermo_(const Teuchos::Ptr<State>& S);
 ...
 protected:
  int niter_;
  Teuchos::RCP<Teuchos::ParameterList> soil_list_;
