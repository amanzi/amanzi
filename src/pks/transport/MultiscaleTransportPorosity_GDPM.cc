...
****************************************************************** */
double
MultiscaleTransportPorosity_GDPM::ComputeSoluteFlux(double flux_liquid,
                                                    double& tcc_f,
                                                    ...
                                                    double phi)
{
  ...
  op.ApplyBCs(tcc_f_mod, Operators::OPERATOR_BC_DIRICHLET, 0.0, Operators::OPERATOR_BC_NEUMANN);
