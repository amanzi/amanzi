...
// TransportBoundaryFunction_Alquimia<Value_Type>::TransportBoundaryFunction_Alquimia(
...
****************************************************************** */
// template <class Value_Type>
// void TransportBoundaryFunction_Alquimia<Value_Type>::Init_(const std::vector<std::string>& regions)
// {
...
****************************************************************** */
// template <class Value_Type>
// void TransportBoundaryFunction_Alquimia<Value_Type>::Compute(double t_old, double t_new) 
// {
