...
class AmanziBelosOp : public Belos::Operator<double> {
 ...
 public:
  ...
  // Apply method
  void
  Apply(const Belos::MultiVec<ScalarType>& x, Belos::MultiVec<ScalarType>& y,
        Belos::ETrans trans = Belos::NOTRANS) const
  {
    const CompositeMultiVector<Vector>* cmx =
      dynamic_cast<const CompositeMultiVector<Vector>*>(&x);
    CompositeMultiVector<Vector>* cmy =
      dynamic_cast<CompositeMultiVector<Vector>*>(&y);
