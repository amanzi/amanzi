...
//! Amanzi::Hypre: A class for constructing and using an ILU factorization of a given Tpetra::RowMatrix, using the Hypre library by Lawrence Livermore National Laboratories.

/*!
Class Amanzi::Hypre: A class for using methods of Hypre with Tpetra objects.
*/
...
public:
  ...
  static_assert (std::is_same<MatrixType, row_matrix_type>::value,
                 "Amanzi::Hypre: MatrixType must be a Tpetra::RowMatrix "
