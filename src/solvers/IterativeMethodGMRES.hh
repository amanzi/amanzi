  ...
  int criteria) const
{
  ...
  WhetStone::DGELS_F77(
    "N", &m, &n, &nrhs, Ttmp.Values(), &m, d.Values(), &m, work.Values(), &lwork, &info);
  ...
  WhetStone::DenseMatrix Vr2(
    krylov_dim_ + 1, num_ritz_ + 1, Vr.Values(), WhetStone::WHETSTONE_DATA_ACCESS_VIEW);
