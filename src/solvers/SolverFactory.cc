  ...
  if (slist.isParameter("solver type")) {
    ...
    if (type == "nka") {
      if (!slist.isSublist("nka parameters")) {
        Errors::Message msg(
          "SolverFactory: missing sublist \"nka parameters\"");
        Exceptions::amanzi_throw(msg);
      }
      ...
      //     Errors::Message msg("SolverFactory: missing sublist \"nka
      //     parameters\""); Exceptions::amanzi_throw(msg);
      //   }
      //   Teuchos::ParameterList aa_list = slist.sublist("aa parameters");
      //   if (!aa_list.isSublist("verbose object")) aa_list.set("verbose
      //   object", slist.sublist("verbose object"));
      //   Teuchos::RCP<Solver<Vector,VectorSpace> > solver =
      ...
      //     search parameters\""); Exceptions::amanzi_throw(msg);
      //   }
      //   Teuchos::ParameterList nka_list = slist.sublist("nka line search
      //   parameters"); if (!nka_list.isSublist("verbose object"))
      //   nka_list.set("verbose object", slist.sublist("verbose object"));
      //   Teuchos::RCP<Solver<Vector,VectorSpace> > solver =
      ...
      //     Errors::Message msg("SolverFactory: missing sublist \"nka_bt_ats
      //     parameters\""); Exceptions::amanzi_throw(msg);
      //   }
      //   Teuchos::ParameterList nka_list = slist.sublist("nka_bt_ats
      //   parameters"); if (!nka_list.isSublist("verbose object"))
      //   nka_list.set("verbose object", slist.sublist("verbose object"));
      //   Teuchos::RCP<Solver<Vector,VectorSpace> > solver =
      ...
      //     Errors::Message msg("SolverFactory: missing sublist \"nka_ls_ats
      //     parameters\""); Exceptions::amanzi_throw(msg);
      //   }
      //   Teuchos::ParameterList nka_list = slist.sublist("nka_ls_ats
      //   parameters"); if (!nka_list.isSublist("verbose object"))
      //   nka_list.set("verbose object", slist.sublist("verbose object"));
      //   Teuchos::RCP<Solver<Vector,VectorSpace> > solver =
      ...
      //     Errors::Message msg("SolverFactory: missing sublist \"JFNK
      //     parameters\""); Exceptions::amanzi_throw(msg);
      //   }
      //   Teuchos::ParameterList jfnk_list = slist.sublist("JFNK parameters");
      //   if (!jfnk_list.isSublist("verbose object")) jfnk_list.set("verbose
      //   object", slist.sublist("verbose object"));
      //   Teuchos::RCP<Solver<Vector,VectorSpace> > solver =
      ...
      //     Errors::Message msg("SolverFactory: missing sublist \"continuation
      //     parameters\""); Exceptions::amanzi_throw(msg);
      //   }
      //   Teuchos::ParameterList cont_list = slist.sublist("continuation
      //   parameters"); if (!cont_list.isSublist("verbose object"))
      //   cont_list.set("verbose object", slist.sublist("verbose object"));
      //   Teuchos::RCP<Solver<Vector,VectorSpace> > solver =
      //       Teuchos::rcp(new
      //       SolverContinuation<Vector,VectorSpace>(cont_list));
      //   return solver;
      // } else if (type == "line search") {
      //   if (!slist.isSublist("line search parameters")) {
      //     Errors::Message msg("SolverFactory: missing sublist \"line search
      //     parameters\""); Exceptions::amanzi_throw(msg);
      //   }
      //   Teuchos::ParameterList ls_list = slist.sublist("line search
      //   parameters"); if (!ls_list.isSublist("verbose object"))
      ...
      //     Errors::Message msg("SolverFactory: missing sublist \"nox
      //     parameters\""); Exceptions::amanzi_throw(msg);
      //   }
      //   Teuchos::ParameterList ls_list = slist.sublist("nox parameters");
      //   if (!ls_list.isSublist("verbose object")) ls_list.set("verbose
      //   object", slist.sublist("verbose object"));
      //   Teuchos::RCP<Solver<Vector,VectorSpace> > solver =
      ...
      Errors::Message msg(
        "SolverFactory: wrong value of parameter `\"solver type`\"");
      Exceptions::amanzi_throw(msg);
    }
  } else {
    Errors::Message msg(
      "SolverFactory: parameter `\"solver type`\" is missing");
    Exceptions::amanzi_throw(msg);
  }
  return Teuchos::null;
}
