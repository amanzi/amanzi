...
TEST_FIXTURE(test_data, JFNK_SOLVER_RIGHT_PC) {
  ...
  TEST_FIXTURE(test_data, NKA_LS_SOLVER_GLOBALIZATION)
  {
    std::cout << std::endl
              << std::endl
              << "----------------------------------------------------------------";
    std::cout << std::endl << "NKA with line search, globalized problem..." << std::endl;
  ...
  TEST_FIXTURE(test_data, NKA_LS_ATS_SOLVER)
  {
    std::cout << std::endl
              << std::endl
              << "----------------------------------------------------------------";
    std::cout << std::endl << "NKA with line search, ATS custom..." << std::endl;
  ...
  /* ******************************************************************/
  TEST_FIXTURE(test_data, LS_SOLVER)
  {
    std::cout << std::endl
              << std::endl
              << "----------------------------------------------------------------";
    ...
    // create the Solver
    Teuchos::RCP<AmanziSolvers::SolverLS<Vector_type, Map_type>> nka_bt =
      Teuchos::rcp(new AmanziSolvers::SolverLS<Vector_type, Map_type>(plist));
    nka_bt->Init(fn, map);
    CHECK(!run(nka_bt));
  };

  /* ******************************************************************/
  TEST_FIXTURE(test_data, LS_SOLVER_GLOBALIZED)
  {
    std::cout << std::endl
              << std::endl
              << "----------------------------------------------------------------";
