#ifndef __State_Old_hpp__
#define __State_Old_hpp__
...
class State_Old : public Teuchos::VerboseObject<State_Old> {
 public:
  State_Old( int, int, Teuchos::RCP<Amanzi::AmanziMesh::Mesh> );

  State_Old(Teuchos::RCP<Amanzi::AmanziMesh::Mesh>);

  State_Old(Teuchos::ParameterList &parameter_list, 
