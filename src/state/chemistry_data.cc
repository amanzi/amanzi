...
chemistry_data::chemistry_data(const Epetra_BlockMap &map, int number_of_components, int number_of_minerals, 
  ...
  if (number_of_ion_exchange_sites > 0) {
    ...
    ion_exchange_ref_cation_conc_ = Teuchos::rcp(new Epetra_MultiVector(map, number_of_ion_exchange_sites));
  } else {
  ...
  if (number_of_sorption_sites > 0) {
    ...
    surface_complex_free_site_conc_ = Teuchos::rcp(new Epetra_MultiVector(map, number_of_sorption_sites));    
  } else {
...
void chemistry_data::store(Teuchos::RCP<Epetra_MultiVector> free_ion_concentrations,
  ...
  if ( mineral_specific_surface_area != Teuchos::null && mineral_specific_surface_area_ != Teuchos::null ) {
  ...
  if ( surface_complex_free_site_conc != Teuchos::null && surface_complex_free_site_conc_ != Teuchos::null ) {
  ...
  if ( ion_exchange_ref_cation_conc != Teuchos::null && ion_exchange_ref_cation_conc_ != Teuchos::null ) {
