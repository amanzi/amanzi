...
class Data_Intf {
 public:
  ...
  virtual void WriteVis(const Visualization& vis, Teuchos::ParameterList& attrs) const = 0;
  virtual void WriteCheckpoint(const Checkpoint& chkp, Teuchos::ParameterList& attrs) const = 0;

  virtual void ReadCheckpoint(const Checkpoint& chkp, Teuchos::ParameterList& attrs) const = 0;
...
class Data_Impl : public Data_Intf {
 public:
  ...
  // virtual interface for ad-hoc polymorphism
  virtual void WriteVis(const Visualization& vis, Teuchos::ParameterList& attrs) const override
  {
    ::Amanzi::Helpers::WriteVis(vis, attrs, *t_);
  }

  virtual void WriteCheckpoint(const Checkpoint& chkp, Teuchos::ParameterList& attrs) const override
  {
    ::Amanzi::Helpers::WriteCheckpoint(chkp, attrs, *t_);
  }

  virtual void ReadCheckpoint(const Checkpoint& chkp, Teuchos::ParameterList& attrs) const override
  {
