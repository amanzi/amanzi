...
template <typename T>
bool InitializePrimitiveByValue(Teuchos::ParameterList &plist,
        const Teuchos::ParameterList& attrs, T &t)
{
...
bool InitializeVectorByValue(Teuchos::ParameterList &plist,
...
bool Initialize(Teuchos::ParameterList &plist, const Teuchos::ParameterList& attrs, Vector_type_<Scalar> &t)
{
  if (InitializeVectorByValue<Vector_type_, Scalar>(plist, attrs, t)) return true;
  return false;
}

template <typename Scalar>
bool Initialize(Teuchos::ParameterList &plist, const Teuchos::ParameterList& attrs, MultiVector_type_<Scalar> &t)
{
  if (InitializeVectorByValue<MultiVector_type_, Scalar>(plist, attrs, t)) return true;
  return false;
}

template <typename Scalar>
bool Initialize(Teuchos::ParameterList &plist, const Teuchos::ParameterList& attrs, CompositeVector_<Scalar> &t)
{
  if (InitializeVectorByValue<CompositeVector_, Scalar>(plist, attrs, t)) return true;
  return false;
}
