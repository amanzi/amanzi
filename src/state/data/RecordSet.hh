...
class RecordSet {
 ...
 public:
  ...
  RecordSet(Key fieldname)
    : fieldname_(fieldname), vis_fieldname_(fieldname), location_(AmanziMesh::Entity_kind::UNKNOWN)
  {}
  ...
  bool ReadCheckpoint(const Checkpoint& chkp, Tag const* const = nullptr);
