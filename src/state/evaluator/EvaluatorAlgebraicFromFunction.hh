...
class EvaluatorAlgebraicFromFunction
    : public EvaluatorAlgebraic<CompositeVector, CompositeVectorSpace> {

public:
  explicit EvaluatorAlgebraicFromFunction(Teuchos::ParameterList &plist);
  EvaluatorAlgebraicFromFunction(const EvaluatorAlgebraicFromFunction &other);
...
private:
  static Utils::RegisteredFactory<Evaluator, EvaluatorAlgebraicFromFunction>
      fac_;
