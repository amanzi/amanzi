...
class Evaluator_BoundaryFunction :
      public EvaluatorIndependent<Functions::BoundaryFunction,Functions::BoundaryFunctionFactory> {
 public:

  explicit Evaluator_BoundaryFunction(Teuchos::ParameterList &plist) :
      EvaluatorIndependent<Functions::BoundaryFunction,Functions::BoundaryFunctionFactory>(plist),
  ...
  virtual void EnsureCompatibility(State &S) override {
    EvaluatorIndependent<Functions::BoundaryFunction,Functions::BoundaryFunctionFactory>::EnsureCompatibility(S);
...
protected:
  ...
  virtual void Update_(State &S) override {
    S.GetW<Functions::BoundaryFunction>(my_key_, my_tag_, my_key_).Compute(S.time(my_tag_));
  }
