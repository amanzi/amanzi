...
public:
  ...
  virtual void Evaluate_(const State &S, const std::vector<CompositeVector*> &results) override {
    ...
    const Epetra_MultiVector &fb_c = *S.Get<CompositeVector>("fb").ViewComponent("cell",false);
    const Epetra_MultiVector &fc_c = *S.Get<CompositeVector>("fc").ViewComponent("cell",false);
    const Epetra_MultiVector &fe_c = *S.Get<CompositeVector>("fe").ViewComponent("cell",false);
    const Epetra_MultiVector &fh_c = *S.Get<CompositeVector>("fh").ViewComponent("cell",false);
  ...
  virtual void EvaluatePartialDerivative_(const State &S, const Key &wrt_key,
    ...
    Epetra_MultiVector &result_c = *results[0]->ViewComponent("cell",false);
    const Epetra_MultiVector &fc_c = *S.Get<CompositeVector>("fc").ViewComponent("cell");
    const Epetra_MultiVector &fe_c = *S.Get<CompositeVector>("fe").ViewComponent("cell");
    const Epetra_MultiVector &fh_c = *S.Get<CompositeVector>("fh").ViewComponent("cell");
...
public:
  ...
  virtual void Evaluate_(const State &S, const std::vector<CompositeVector*> &results) override {
    Epetra_MultiVector &result_c = *results[0]->ViewComponent("cell",false);
    const Epetra_MultiVector &fd_c = *S.Get<CompositeVector>("fd").ViewComponent("cell",false);
    const Epetra_MultiVector &fg_c = *S.Get<CompositeVector>("fg").ViewComponent("cell",false);
...
public:
  ...
  virtual void Evaluate_(const State &S, const std::vector<CompositeVector*> &results) override {
    Epetra_MultiVector &result_c = *results[0]->ViewComponent("cell",false);
    const Epetra_MultiVector &fd_c = *S.Get<CompositeVector>("fd").ViewComponent("cell",false);
    const Epetra_MultiVector &ff_c = *S.Get<CompositeVector>("ff").ViewComponent("cell",false);
