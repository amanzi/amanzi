...
*/
  TEST(HDF5_MPI_AND_SERIAL)
  {
    ...
    auto domain_mesh = Teuchos::rcp(new AmanziMesh::Mesh(domain_mesh_mstk, Teuchos::rcp(new Amanzi::AmanziMesh::MeshFrameworkAlgorithms()), Teuchos::null)); 
    auto serial_mesh = Teuchos::rcp(new AmanziMesh::Mesh(serial_mesh_mstk, Teuchos::rcp(new Amanzi::AmanziMesh::MeshFrameworkAlgorithms()), Teuchos::null)); 
