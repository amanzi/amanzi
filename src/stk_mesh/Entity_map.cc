...
stk::mesh::EntityRank Entity_map::kind_to_rank (Mesh_data::Entity_kind kind) const
{
...
Mesh_data::Entity_kind Entity_map::rank_to_kind (stk::mesh::EntityRank rank) const
{
