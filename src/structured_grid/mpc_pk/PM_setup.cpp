...
Real PorousMedia::steady_abs_residual_tolerance;
Real PorousMedia::steady_rel_residual_tolerance;
Real PorousMedia::steady_abs_saturation_update_tolerance;
Real PorousMedia::steady_rel_saturation_update_tolerance;
Real PorousMedia::steady_abs_pressure_update_tolerance;
Real PorousMedia::steady_rel_pressure_update_tolerance;
Real PorousMedia::steady_initial_time_step;
Real PorousMedia::steady_max_time_steps;
Real PorousMedia::steady_max_psuedo_time;
int  PorousMedia::steady_max_num_consecutive_residual_decreases;
Real PorousMedia::steady_extra_time_step_increase_factor;
int  PorousMedia::steady_max_num_consecutive_residual_increases;
Real PorousMedia::steady_consecutive_increase_reduction_factor;
bool PorousMedia::steady_use_petsc_dt_control;
...
PorousMedia::InitializeStaticVariables ()
{
  ...
  PorousMedia::steady_abs_residual_tolerance = 1.e-6;
  PorousMedia::steady_rel_residual_tolerance = -1;
  PorousMedia::steady_abs_saturation_update_tolerance = -1;
  PorousMedia::steady_rel_saturation_update_tolerance = -1;
  PorousMedia::steady_abs_pressure_update_tolerance = 1.e-5;
  PorousMedia::steady_rel_pressure_update_tolerance = 1.e-8;
  PorousMedia::steady_initial_time_step = 1.e2;
  PorousMedia::steady_max_time_steps = 8000;
  PorousMedia::steady_max_psuedo_time = 1.e30;
  PorousMedia::steady_max_num_consecutive_residual_decreases = 3;
  PorousMedia::steady_extra_time_step_increase_factor = 10.;
  PorousMedia::steady_max_num_consecutive_residual_increases = 3;
  PorousMedia::steady_consecutive_increase_reduction_factor = 0.15;
  PorousMedia::steady_use_petsc_dt_control = true;
...
void PorousMedia::read_prob()
{
  ...
  pb.query("steady_abs_residual_tolerance",steady_abs_residual_tolerance);
  pb.query("steady_rel_residual_tolerance",steady_rel_residual_tolerance);
  pb.query("steady_abs_saturation_update_tolerance",steady_abs_saturation_update_tolerance);
  pb.query("steady_rel_saturation_update_tolerance",steady_rel_saturation_update_tolerance);
  pb.query("steady_abs_pressure_update_tolerance",steady_abs_pressure_update_tolerance);
  pb.query("steady_rel_pressure_update_tolerance",steady_rel_pressure_update_tolerance);
  ...
  pb.query("steady_max_num_consecutive_residual_decreases",steady_max_num_consecutive_residual_decreases);
  pb.query("steady_extra_time_step_increase_factor",steady_extra_time_step_increase_factor);
  pb.query("steady_max_num_consecutive_residual_increases",steady_max_num_consecutive_residual_increases);
  pb.query("consecutive_increase_reduction_factor",steady_consecutive_increase_reduction_factor);
  pb.query("steady_use_petsc_dt_control",steady_use_petsc_dt_control);
