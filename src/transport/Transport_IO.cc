...
void Transport_PK::ProcessParameterList()
{
  ...
  if (transport_list.isSublist("dispersivity")) {
    ...
    dispersion_specs.alphaL = dispersivity.get<double>("longitudinal", 0.0);
    dispersion_specs.alphaT = dispersivity.get<double>("transverse", 0.0);
    dispersion_specs.D = dispersivity.get<double>("molecular diffusion", 0.0);
