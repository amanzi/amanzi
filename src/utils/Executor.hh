...
template <template <typename> class Model, class DeviceType = DefaultDevice>
void
ExecuteModel(const std::string& kernelName,
             ...
             DeviceType /* dev */ = DeviceType())
{
  ...
  Kokkos::parallel_for("Evaluator::ExecuteModel", kernelName, range(beg, end), model);
}

// Execute over a continuous range, with tag.
template <template <typename> class Model, class TagType, class DeviceType = DefaultDevice>
void
ExecuteModel(const std::string& kernelName,
             Model<DeviceType>& model,
             TagType /* tag */,
