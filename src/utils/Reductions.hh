                           ...
                           Kokkos::View<const LO*, DefaultMemorySpace>* indices = nullptr)
{
  ...
  if (indices) {
    ...
    Kokkos::parallel_reduce("Amanzi::reduceAll",
...
MinLoc<Scalar,GO> reduceAllMinLoc(const Vector_type_<Scalar>& vec,
        Kokkos::View<const LO*, DefaultMemorySpace>* indices = nullptr)
{
...
template<typename Scalar>
MaxLoc<Scalar,GO> reduceAllMaxLoc(const Vector_type_<Scalar>& vec,
        Kokkos::View<const LO*, DefaultMemorySpace>* indices = nullptr)
{
