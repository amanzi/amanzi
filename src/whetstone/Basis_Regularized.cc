...
****************************************************************** */
void Basis_Regularized::ChangeBasisMyToNatural(DenseVector& v, int nrows) const
{
...
* Special transformation for vector discretizations
****************************************************************** */
void Basis_Regularized::ChangeBasisNaturalToMy(DenseVector& v, int nrows) const
{
  int stride = v.NumRows() / nrows;
