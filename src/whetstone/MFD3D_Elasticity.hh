...
class MFD3D_Elasticity : public MFD3D {
 public:
  ...
  // optimization methods (mainly for research, since the maximum principle does
  // not exists)
 ...
 private:
  void MatrixMatrixProduct_(const DenseMatrix& A, const DenseMatrix& B,
                            bool transposeB, DenseMatrix& AB);
