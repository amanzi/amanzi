...
****************************************************************** */
template<class T>
void MatrixObjects<T>::reshape(int d, int m, int n, int order, bool reset)
{
  d_ = d;
  m_ = m;
  n_ = n;
...
****************************************************************** */
template<class T>
MatrixObjects<T>& MatrixObjects<T>::operator+=(const MatrixObjects<T>& mp)
{
  for (int i = 0; i < m_; ++i)
    for (int j = 0; j < n_; ++j)
      polys_[i][j] += mp(i, j);
...
****************************************************************** */
template<class T>
void MatrixObjects<T>::set_origin(const AmanziGeometry::Point& origin)
{
  for (int i = 0; i < m_; ++i)
    for (int j = 0; j < n_; ++j)
...
****************************************************************** */
template<class T>
void MatrixObjects<T>::ChangeOrigin(const AmanziGeometry::Point& origin)
{
  for (int i = 0; i < m_; ++i)
    for (int j = 0; j < n_; ++j)
...
****************************************************************** */
template<class T>
double MatrixObjects<T>::NormInf() const
{
  double tmp(0.0);
  for (int i = 0; i < m_; ++i)
    for (int j = 0; j < n_; ++j)
