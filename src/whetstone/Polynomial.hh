...
class Polynomial : public PolynomialBase<MEMSPACE> {
 ...
 public:
   ...
   ****************************************************************** */
  Polynomial(int d, const int* multi_index, double factor) : PolynomialBase<MEMSPACE>(d, 0)
  {
   ...
   * Copy constructor.
   ****************************************************************** */
  Polynomial(const Polynomial<MEMSPACE>& poly) : PolynomialBase<MEMSPACE>(poly.d_, poly.order_)
  {
...
template <class MEMSPACE>
Polynomial<MEMSPACE>
operator*(double val, const Polynomial<MEMSPACE>& poly)
{
...
template <class MEMSPACE>
Polynomial<MEMSPACE>
operator*(const Polynomial<MEMSPACE>& poly, double val)
{
  Polynomial<MEMSPACE> tmp(poly);
  for (int n = 0; n < tmp.size(); ++n) tmp(n) *= val;
  return tmp;
