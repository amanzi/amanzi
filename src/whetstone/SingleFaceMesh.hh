...
class SingleFaceMesh : public AmanziMesh::MeshFramework {
 public:
  ...
  // ---------------------
  void getCellNodes(const AmanziMesh::Entity_ID c, AmanziMesh::Entity_ID_List& nodes) const override
  {
    AMANZI_ASSERT(c == 0);
    nodes = cell_node_ids_;
  }

  void getFaceNodes(const AmanziMesh::Entity_ID f, AmanziMesh::Entity_ID_List& nodes) const override
  {
    AMANZI_ASSERT(f < nnodes_);
    nodes = face_node_ids_[f];
  }

  void getEdgeNodes(const AmanziMesh::Entity_ID e, AmanziMesh::Entity_ID_List& nodes) const override
  {
  ...
  getEntityPtype(const AmanziMesh::Entity_kind kind, const AmanziMesh::Entity_ID ent) const override
  {
