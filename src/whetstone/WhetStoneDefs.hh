...
const int NODE = (int) AmanziMesh::Entity_kind::NODE;
const int EDGE = (int) AmanziMesh::Entity_kind::EDGE;
const int FACE = (int) AmanziMesh::Entity_kind::FACE;
const int CELL = (int) AmanziMesh::Entity_kind::CELL;
const int BOUNDARY_FACE = (int) AmanziMesh::Entity_kind::BOUNDARY_FACE;
