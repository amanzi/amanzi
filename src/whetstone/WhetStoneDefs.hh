...
const int WHETSTONE_ELEMENTAL_MATRIX_FAILED =
  2; // only for unexpected situations
...
const double WHETSTONE_SIMPLEX_MAX_ITERATIONS =
  100; // factor of number of unknowns
