...
RegisteredFactory<MFD3D_GeneralizedDiffusion> MFD3D_GeneralizedDiffusion::factory_("diffusion generalized");
...
RegisteredFactory<VEM_NedelecSerendipity> VEM_NedelecSerendipity::factory_("Nedelec serendipity");
