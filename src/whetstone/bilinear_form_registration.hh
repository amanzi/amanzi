...
RegisteredFactory<MFD3D_BernardiRaugel>
  MFD3D_BernardiRaugel::factory_("BernardiRaugel");
RegisteredFactory<MFD3D_CrouzeixRaviart>
  MFD3D_CrouzeixRaviart::factory_("CrouzeixRaviart");
...
RegisteredFactory<MFD3D_Generalized_Diffusion>
  MFD3D_Generalized_Diffusion::factory_("diffusion generalized");
RegisteredFactory<MFD3D_Elasticity> MFD3D_Elasticity::factory_("elasticity");
RegisteredFactory<MFD3D_Electromagnetics>
  MFD3D_Electromagnetics::factory_("electromagnetics");
