...
extern "C"
{
  ...
  void PREFIX DSYEV_F77(const char* jobz,
                        const char* uplo,
                        int* n,
                        double* a,
                        int* lda,
  ...
  void PREFIX DGESVD_F77(const char* jobu,
                         const char* jobvt,
                         int* nrow,
                         int* ncol,
                         double* a,
  ...
  void PREFIX DGEEV_F77(const char* jobu,
                        const char* jobvt,
                        int* n,
                        double* a,
                        int* lda,
  ...
  void PREFIX DGEES_F77(const char* jobvs,
                        const char* sort,
