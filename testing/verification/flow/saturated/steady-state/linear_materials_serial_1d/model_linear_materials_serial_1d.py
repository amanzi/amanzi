...
def createFromXML(filename):
    ...
    #  Material Properties
    #
    params["k1"]  = search.getElementByPath(xml, "/Main/Material Properties/Left Material/Intrinsic Permeability: Uniform/Value").value
    params["k2"]  = search.getElementByPath(xml, "/Main/Material Properties/Right Material/Intrinsic Permeability: Uniform/Value").value
