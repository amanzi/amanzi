...
function(ADD_AMANZI_COMPARISON_TEST test_name)
  ...
  if ( AMANZI_COMPARISON_TEST_RELATIVE_TOLERANCE AND AMANZI_COMPARISON_TEST_ABSOLUTE_TOLERANCE )
    message(FATAL_ERROR "Only one of RELATIVE_TOLERANCE or ABSOLUTE_TOLERANCE may be given.")
  endif()
  ...
  if (AMANZI_COMPARISON_TEST_FIELD)
    if (AMANZI_COMPARISON_TEST_RELATIVE_TOLERANCE)
      add_test(NAME compare_${test_name}_field COMMAND ${PYTHON_EXECUTABLE} ${AMANZI_SOURCE_DIR}/tools/testing/compare_field_results.py ${AMANZI_COMPARISON_TEST_FIELD} ${AMANZI_COMPARISON_TEST_INPUT} ${AMANZI_COMPARISON_TEST_REFERENCE} "relative" ${AMANZI_COMPARISON_TEST_RELATIVE_TOLERANCE})
    elseif(AMANZI_COMPARISON_TEST_ABSOLUTE_TOLERANCE)
      add_test(NAME compare_${test_name}_field COMMAND ${PYTHON_EXECUTABLE} ${AMANZI_SOURCE_DIR}/tools/testing/compare_field_results.py ${AMANZI_COMPARISON_TEST_FIELD} ${AMANZI_COMPARISON_TEST_INPUT} ${AMANZI_COMPARISON_TEST_REFERENCE} "absolute" ${AMANZI_COMPARISON_TEST_ABSOLUTE_TOLERANCE})
    endif()
    ...
    if (AMANZI_COMPARISON_TEST_RELATIVE_TOLERANCE)
      add_test(NAME compare_${test_name}_observation COMMAND ${PYTHON_EXECUTABLE} ${AMANZI_SOURCE_DIR}/tools/testing/compare_observation_results.py ${AMANZI_COMPARISON_TEST_OBSERVATION} ${AMANZI_COMPARISON_TEST_INPUT} ${AMANZI_COMPARISON_TEST_REFERENCE} "relative" ${AMANZI_COMPARISON_TEST_RELATIVE_TOLERANCE})
    elseif(AMANZI_COMPARISON_TEST_ABSOLUTE_TOLERANCE)
      add_test(NAME compare_${test_name}_observation COMMAND ${PYTHON_EXECUTABLE} ${AMANZI_SOURCE_DIR}/tools/testing/compare_observation_results.py ${AMANZI_COMPARISON_TEST_OBSERVATION} ${AMANZI_COMPARISON_TEST_INPUT} ${AMANZI_COMPARISON_TEST_REFERENCE} "absolute" ${AMANZI_COMPARISON_TEST_ABSOLUTE_TOLERANCE})
    endif()
